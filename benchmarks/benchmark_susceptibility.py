import numpy as np
import time
from physics.response.susceptibility import susceptibility_multi_omega, susceptibility_lehmann
...
def benchmark_susceptibility():
    ...
    # Theoretical estimate of repetitions of expensive operations:
    # O(N^3) matrix multiplication is called 200 times.
