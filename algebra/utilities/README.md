...
| `udt.py` | UDT factorizations and Loh-style stable inverse formulas for long matrix products. | Supports standard QR-based UDT updates and a NumPy/SciPy pivoted-QR variant for stronger stabilization/reference calculations. |
